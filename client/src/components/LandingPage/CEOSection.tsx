...
const loopedPosts = [...ceoPosts, ...ceoPosts, ...ceoPosts, ...ceoPosts];

/* ─────────────────────────────────────────────────────────────────
   CARD
───────────────────────────────────────────────────────────────── */
const PostCard = ({ post }: { post: (typeof ceoPosts)[0]; index: number }) => (
  <div
    ...
    <section className="bg-[#202020] py-10 md:py-16 lg:py-20 overflow-hidden">
      <div className="w-full mx-auto px-4 sm:px-6">
        ...
        <div className="flex justify-between items-center mb-8 md:mb-10 gap-4">
          ...
          <a
            href="#"
            className="flex-shrink-0 text-white/60 text-xs sm:text-sm hover:text-white font-montserrat
                       transition-colors tracking-wide border-b border-white/10 pb-0.5 whitespace-nowrap"
          >
            Shop Instagram
          </a>
        </div>
        ...
        >
          <motion.div
            ...
            /* Pause on hover by toggling animation play state */
          >
          ...
          {/* Left edge fade */}
          {/* <div className="absolute left-0 top-0 bottom-0 w-12 md:w-20
                          bg-gradient-to-r from-[#202020] to-transparent
                          pointer-events-none z-10" /> */}
          {/* Right edge fade */}
          {/* <div className="absolute right-0 top-0 bottom-0 w-12 md:w-20
                          bg-gradient-to-l from-[#202020] to-transparent
                          pointer-events-none z-10" /> */}
        </div>
      </div>
    </section>
