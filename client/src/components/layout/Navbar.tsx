            ...
            <div className="flex justify-between items-center w-full">
                ...
                <div className="hidden xl:flex font-sans font-normal gap-[24px] 2xl:gap-[32px] justify-center items-center text-base 2xl:text-xl">
                    {navLinks.map((link) => (
                        <div key={link.label} className="flex items-center gap-2">
                            {link.scrollTo ? (
                                <button
                                    className="hover:text-[#CEA574] text-[#FFFFFF] transition-colors cursor-pointer font-gilroy"
                            ...
                            {link.isNew && (
                                <span className="bg-[#B88F5F] text-xs w-10 text-center rounded-2xl h-4 leading-4 text-white font-medium font-gilroy">
                                    NEW
                                </span>
                            )}
                        </div>
                ...
                <div className="flex items-center gap-4">
                    <div className="bg-[#B88F5F] flex justify-center items-center h-9 sm:h-11 xl:h-13 px-3 xl:w-40 rounded-3xl ml-4">
                        <Link
                            className="inline-block uppercase text-white text-xs xl:text-base whitespace-nowrap font-gilroy"
                            to="/"
                        >
                            Enquire Now
                        </Link>
